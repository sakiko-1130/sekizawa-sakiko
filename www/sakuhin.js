   ...
   var mangas = [
      ...
      'text' :
      "高校生のちょっと不思議な恋のお話。ある日突然性別が変わってしまっていた(男→女)。そんな時小さい頃に幼馴染でチームメイトだった子に再開する‼"},
      
      {'id':"恋愛" , 'title': "ワンダフルデイズ",
      'text' :
      "これまた不思議なお話。夜になると犬になってしまう女と犬が大嫌いな男の話。すれ違いがたくさんあってもどかしいけど、男も女も可愛らしくてずっと見ていられる。"},
      ...
      {'id':"戦闘" , 'title': "七つの大罪",
      'text' :
      "七つの大罪問いわれる7人の大罪人を探す話。最初に出会う団長・メリオダスが変態だけどやるときはやるかっこいい人。"},
 ...
 // 15
      ...
      {'id':"塔を上る" , 'title': "神之塔",
      'text' :
      "ずっと塔の中で生活してきた主人公・夜が好きな子・ラヘルが空を見てみたいという願いのために塔の頂上を目指していく。夜の秘めたる力がどんなものなのかどんどん気になってきてしまう！"},
      // 20
      {'id':"料理" , 'title': "パパと親父のウチのご飯",
      'text' :
      "シングルファザー2組のシェアハウス。育児に苦戦するも料理を通して子供たちと心を通じ合うシーンがほっこりします！"},
   ...
   var animes =[
      ...
      'text' :
      "アイドルの話。というよりもアイドルを追いかけるヲタクのお話。ヲタク同士の会話のやり取りがとにかく面白い。こんな夢中になれるものがあるの羨ましくなる。" },
   ];
